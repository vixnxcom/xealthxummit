...
import { invest, lead, mind } from '../assets';

const AnimatedCircleLife = ({
  size = 'lg',
}) => {
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <img src={invest} alt="" className='w-20 h-20'/> {/* Reduced from w-28 h-28 */}
              </div>
            </div>
          </div>
        </div>
...
export default AnimatedCircleLife;