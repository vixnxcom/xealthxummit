  ...
  return (
    <div className={`] flex   mx-auto`}>
      <div className='mx-auto'>
         <button className='mx-auto mt-5 backdrop-blur-50 bg-cyan   shadow md:w-[35vw]
          ...
          <p className='editors-reg font-medium text-white text-[20px] flex flex-row items-center'>
           Buy Ticket
            <span className='bg-white w-10 h-10 rounded-full mx-2 flex items-center justify-center'>
