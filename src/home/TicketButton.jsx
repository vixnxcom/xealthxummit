...
const TicketButton = () => {
  ...
  <TypewriterText>
    <li className="py-3 mb-5 mt-5 flex items-start gap-3 leading-relaxed">
      ...
      <p className="text-justify mr-3">
                  The HealthTech Innovation Summit brings together senior clinicians, healthcare leaders, policymakers, investors, and technology innovators to explore how technology can transform healthcare delivery across Africa and emerging markets. Through keynote talks, expert panels, and focused discussions, the summit addresses real-world challenges, practical solutions, and scalable innovations shaping the future of healthcare.
          </p>
                </li>
              </TypewriterText>
            </ul>
  ...
  <TypewriterText>
    <li className="py-3 mb-5 mt-5 flex items-start gap-3 leading-relaxed">
      <span className="w-3 h-3 bg-cyan shrink-0 mt-2 "></span>
      <p className="text-justify mr-3">
                  The National HealthTech Excellence Awards celebrate organisations, startups, and individuals driving meaningful change in healthcare through innovation and technology. The awards recognise excellence across clinical innovation, digital health, AI, policy, investment, and social impact, highlighting leaders shaping the future of healthcare. </p>
                </li>
              </TypewriterText>
            </ul>
          </div>
  ...
  <TypewriterText>
    <li className="py-3 mb-5 mt-5 flex items-start gap-3 leading-relaxed">
      <span className="w-3 h-3 bg-cyan shrink-0 mt-2 "></span>
      <p className="text-justify mr-3">
                  The Networking & Innovation Exhibition creates a dedicated space for meaningful engagement between innovators, healthcare providers, investors, corporates, and policymakers. Attendees can explore cutting-edge solutions, connect with potential partners, and initiate collaborations that extend beyond the event.
                </p>
                </li>
              </TypewriterText>
            </ul>
  ...
  <TypewriterText>
    <li className="py-3 mb-5 mt-5 flex items-start gap-3 leading-relaxed">
      <span className="w-3 h-3 bg-cyan shrink-0 mt-2 "></span>
      <p className="text-justify mr-3">
                  The Startup Pitch Finals provide a high-profile platform for selected healthtech startups to pitch their solutions to investors, industry leaders, and strategic partners. Finalists are evaluated on innovation, clinical relevance, scalability, and impact, with opportunities for funding, partnerships, and ecosystem support.
              </p> </li>
              </TypewriterText>
            </ul>
          </div>
