...
const FaqAbout = () => {
  ...
  return (
    <section>
      <div className="relative w-screen h-[80vh] md:h-[85vh] overflow-hidden bg-faq">
      ...
      AWARD NOMINATIONS
          ...
          <h2 className="text-white tracking-widest mt-2 editors-reg text-[25px] mt-24 md:text-[32px] ">
            2026 Event
          </h2>
        </div>
