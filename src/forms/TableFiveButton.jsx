    ...
    <div className={` flex   mx-auto`}>
      <div className='mx-auto'>
         <button className='mx-auto mt-15 mb-5  bg-cyan hover:!bg-black hover:scale-103 cursor-pointer
          ...
          <Link to='/table' className='editors-reg text-shade  text-white text-[16px] flex flex-row items-center'>
           Register Table for 5
...
export default TableFiveButton